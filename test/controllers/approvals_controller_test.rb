...
class ApprovalsControllerTest < ActionController::TestCase
  ...
  test "should create approval" do
    assert_difference('Approval.count') do
      post :create, approval: { approve: @approval.approve, friendship_id: @approval.friendship_id, membership_id: @approval.membership_id, subscription_id: @approval.subscription_id, user_id: @approval.user_id }
    end
  ...
  test "should update approval" do
    patch :update, id: @approval, approval: { approve: @approval.approve, friendship_id: @approval.friendship_id, membership_id: @approval.membership_id, subscription_id: @approval.subscription_id, user_id: @approval.user_id }
    assert_redirected_to approval_path(assigns(:approval))
  end
